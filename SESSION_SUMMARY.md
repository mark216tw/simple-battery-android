...
- 提供以下模式：
  ...
  - 淺色模式。
  - 深色模式。
- 提供暖陽黃、珊瑚紅、活力橘、青草綠、天空藍及葡萄紫六種預設 APP 主題色。
- 提供單一色相彩色滑桿，自訂 APP 主題色；拖曳時即時預覽，放開後保存並套用。
- 主題模式與主題色變更後立即套用，背景與 Surface 同步使用淡主題色調。
